...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        #create fast lookup dictionaries by primary designation and name (most NEOs don't have a name)
        ...
        for approach in self._approaches:
            ...
            self.neos_by_pdes[approach._designation].approaches.append(approach)
    ...
    def query(self, filters=()):
        ...
        """
        for approach in self._approaches:
            # all filters need to be True for an approach to be included in the results
